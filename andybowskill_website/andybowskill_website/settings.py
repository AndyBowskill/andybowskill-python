"""
Django settings for andybowskill_website project.
...
PROJECT_DIR = os.path.join(BASE_DIR, "andybowskill_website")
...
SECRET_KEY = '&2jrh+kvcb1-sxo_h$c_s&n4#u8qer602zv@b(yxy^b-&dqiw+'
...
INSTALLED_APPS = [
    ...
    'andybowskill_website.apps.blog',
]
...
ROOT_URLCONF = 'andybowskill_website.urls'
